...
import com.interswitch.StyleMe.dto.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(StyleMeException.class)
    public ResponseEntity<ErrorDetails> handleAccountException(StyleMeException exception, WebRequest webRequest) {
