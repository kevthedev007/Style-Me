...
def shirts_and_skirts_with_bags_and_shoes(shirts_folder_id, skirts_folder_id, bags_folder_id, shoes_folder_id):
    ...
    # best_match=best_matches[100]
    # print(len(best_matches))
    # plt.subplot(1, 4, 1)
    # plt.imshow(shirt_images[best_match[0]])
    # plt.title("Top")
    # plt.subplot(1, 4, 2)
    # plt.imshow(skirts_images[best_match[1]])
    # plt.subplot(1, 4, 3)
...
def get_skirt_recommendations(skirts, shirts, shoes, bags):
    skirt_list=[]
    if skirts and shirts and shoes and bags:
...
# # a=shirts_and_skirts_with_bags_and_sehoes(shirts_folder_id=shirts_folder_id, skirts_folder_id=skirts_folder_id, shoes_folder_id=shoes_folder_id, bags_folder_id=bags_folder_id)
# # print(a)
# # a=shirts_and_skirts_with_bags(shirts_folder_id=shirts_folder_id, skirts_folder_id=skirts_folder_id, bags_folder_id=bags_folder_id)
# # print(a)
# a=shirts_and_skirts_with_shoes(shirts_folder_id=shirts_folder_id, skirts_folder_id=skirts_folder_id, shoes_folder_id=shoes_folder_id)
# print(a)